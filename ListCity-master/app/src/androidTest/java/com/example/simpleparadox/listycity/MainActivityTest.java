...
public class MainActivityTest{
    ...
    public void checkList(){
        ...
        solo.enterText((EditText) solo.getView(R.id.editText_name), "shamsularifeen08");
        ...
        /* True if there is any text: shamsularifeen08 on the screen, wait at least 2 seconds and
        find minimum one match. */
        assertTrue(solo.waitForText("shamsularifeen08", 1, 2000));

        solo.clickOnButton("CLEAR ALL"); //Select ClEAR ALL
        //True if there is no text: shamsularifeen08 on the screen
        assertFalse(solo.searchText("shamsularifeen08"));
    ...
    public void checkCiyListItem(){
        ...
        solo.waitForText("shamsularifeen08", 1, 2000);
        ...
        assertEquals("shamsularifeen08", city);
    }
